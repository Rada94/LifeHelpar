...
/**
 * Servlet implementation class ImgPac
 */
@WebServlet("/ImgPac")
public class ImgPac extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rs= stmnt.executeUpdate("update pacientes set foto='"+foto_pac+"' where id_paciente="+id_pac+";");
				//update pacientes set foto ="foto" where id_paciente =3;
			//rs= stmnt.executeUpdate("INSERT INTO pacientes (foto) VALUES ('"+nombre_pac+"','"+apellido_pac+"',"+edad_pac+",'"+sexo_pac+"','"+domicilio_pac+"',"+telefono_pac+",'"+expediente_pac+"','"+pac_incidencia+"');");
