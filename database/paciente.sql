...
telefono_pac int not null, /*Numero de celular*/
email_pac varchar(90) not null unique, /*Correo electrónico del paciente*/
pass_pac varchar(8) not null, 
expediente_pac varchar(10000), /*Comentarios de doctor al paciente*/
incidencia_pac varchar(3000),
...
BEGIN
	INSERT INTO login (perfil, emails, passwords) VALUES ("Paciente", NEW.email_pac, NEW.pass_pac);
END; //
